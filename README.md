...
The double click feature was built in two ways. One built with the defaults double click and the other simulating a double click between the time of two individual clicks.

This project was built with HTML (FontAwesome included), CSS and JS.

![chrome-capture-2023-1-23](https://user-images.githubusercontent.com/110612670/220867746-b2bd739b-ff55-4541-b438-7c1442eff6a9.gif)
#

## [30-50-Auto-Text-Effect](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/30-50-Auto-Text-Effect)
A project display text letter by letter and the speed can can altered using a number input.
...
## [36-50-Hoverboard](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/36-50-Hoverboard)
A fun project that play with hover and transistion effects to display a coloured square with a delayed tail fade.

The project is made with HTML, CSS and JS.

![chrome-capture-2023-2-7 (1)](https://user-images.githubusercontent.com/110612670/223512338-551b46a2-c701-477c-b4af-fa3132633396.gif)
#

## [37-50-Pokedex](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/37-50-Pokedex)
A Project that pulls from a [pokemon API](https://pokeapi.co/api/v2/pokemon/) to display the first generation pokemon (151).

The amount of pokemon can be increased by changing the variable amount mentioned below in the script.js file:
...
![chrome-capture-2023-2-8](https://user-images.githubusercontent.com/110612670/223725157-8f22a65a-cd4e-45e0-be08-db7af83d2f6e.gif)
#

## [38-50-Mobile-Tab-Navigation](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/38-50-Mobile-Tab-Navigation)
This project just displays a very basic mobile tab navigation which changes the image upon menu choice.

This project could be tweaked to actually be like a mobile display for different pages.
...
The project was built with HTML that included some [Tailwind (v1.8.11)](https://cdnjs.cloudflare.com/ajax/libs/tailwindcss/1.8.11/tailwind.min.css) (very old) which was included the `head`, CSS and JS.
...
## [41-50-Verify-Account-UI](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/41-50-Verify-Account-UI)
A project just creating the UI for the verification process of signing up / creating an account.

The project allows the user to type each number (0...9) and upon entering a number it goes to the next input.

The project allows the use of backspace to backstep a number.
...
## [46-50-Quiz-App](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/46-50-Quiz-App)
...
## [48-50-Random-Image-Feed](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/48-50-Random-Image-Feed)
...
## [50-50-Insect-Catch-Game](https://github.com/alpaca-rama/50-Projects-In-50-Days/tree/main/50-50-Insect-Catch-Game)
